...
<!-- jQuery Mapael -->
<script src="<?php echo URL_RESOURCES;?>adminlte/plugins/jquery-mousewheel/jquery.mousewheel.js"></script>
<script src="<?php echo URL_RESOURCES;?>adminlte/plugins/raphael/raphael.min.js"></script>
<script src="<?php echo URL_RESOURCES;?>adminlte/plugins/jquery-mapael/jquery.mapael.min.js"></script>
<script src="<?php echo URL_RESOURCES;?>adminlte/plugins/jquery-mapael/maps/usa_states.min.js"></script>
<!-- ChartJS -->
